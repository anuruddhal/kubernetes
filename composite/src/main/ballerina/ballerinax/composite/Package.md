...
This package provides an implementation for connecting and interacting with composite endpoints. The package facilitates two types of endpoints as ‘Client’ and ‘Listener’. 
